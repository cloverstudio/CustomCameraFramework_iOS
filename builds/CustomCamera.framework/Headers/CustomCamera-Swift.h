...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CustomCamera",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12CustomCamera22CustomCameraConfigFile")
@interface CustomCameraConfigFile : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)setHoldForVideoTapForImageStringWithText:(NSString * _Nonnull)text;
- (void)setSlideYourFingerUpToZoomInStringWithText:(NSString * _Nonnull)text;
- (void)setCameraFrontIconWithImage:(UIImage * _Nonnull)image;
- (void)setCameraRearIconWithImage:(UIImage * _Nonnull)image;
- (void)setFlashOffIconWithImage:(UIImage * _Nonnull)image;
- (void)setFlashOnIconWithImage:(UIImage * _Nonnull)image;
...
SWIFT_PROTOCOL("_TtP12CustomCamera20CustomCameraDelegate_")
